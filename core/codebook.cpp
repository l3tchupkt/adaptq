...
const float CB4[16] = {
    -2.7326f, -2.0690f, -1.6182f, -1.2560f,
    -0.9424f, -0.6568f, -0.3881f, -0.1284f,
     0.1284f,  0.3881f,  0.6568f,  0.9424f,
     1.2560f,  1.6182f,  2.0690f,  2.7326f
};
...
static const float THRESH4[15] = {
    ...
    (-2.0690f-1.6182f)*0.5f,
    (-1.6182f-1.2560f)*0.5f,
    (-1.2560f-0.9424f)*0.5f,
    ...
    ( 0.9424f+1.2560f)*0.5f,
    ( 1.2560f+1.6182f)*0.5f,
    ( 1.6182f+2.0690f)*0.5f,
